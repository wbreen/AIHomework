...
public class WorldCreatePanel extends JPanel implements ActionListener, ItemListener {
    ...
    //String[] vacuumStrings = {"Random Vacuum Agent", "Reactive Vacuum Agent", "DumbVacuumAgent"};
    /**
    ...
    public WorldCreatePanel(JFrame f, HashMap<String, VacuumAgent> agts)
    {
    	...
    	//vacuumStrings = (String[]) (agentMap.keySet().toArray());
    	holder = f;
    ...
    private Agent createAgent(String agentName) {
    	...
    	else if (agentName == "DumbVacuumAgent") return new DumbVacuumAgent();
